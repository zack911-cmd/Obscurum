...
/**
 * Common English typo corrections — separate from TOOL_CORRECTIONS so tool
 * names and everyday spelling stay independently maintainable. Both are
 * merged together at the call site (ChatWindow) for the live auto-correct
 * feature. This is a hardcoded list, not a real dictionary — it only
 * catches typos explicitly added here, not arbitrary misspellings.
 */
